...
log_level = 'INFO'
work_dir = '/content/gdrive/My Drive/Arirang/models/s2anet_r50_fpn_1x_ms_rotate_etc_adam/'
...
resume_from = '/content/gdrive/My Drive/Arirang/models/s2anet_r50_fpn_1x_ms_rotate_etc_adam/latest.pth'
workflow = [('train', 1)]
# r50
